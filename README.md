...
Merged into spi as a feature. Kept as a pointer.
...
Merged into [`spi`](https://github.com/Tape-Out/spi) as its quad feature. This repository is archived and kept only as a pointer.
